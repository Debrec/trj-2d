...
CONTAINS
  ...
  SUBROUTINE nf(status) ! turns nf90_* function into subroutine + checks status
    ...
    IF (status /= nf90_noerr) THEN
       ...
       WRITE (*,*) 'netcdf error: trj netcdf ', nf90_strerror(status)
       STOP
    ENDIF
  END SUBROUTINE nf
...
CONTAINS
  ...
  SUBROUTINE nf(status) ! turns nf90_* function into subroutine + checks status
    INTEGER :: status
    IF (status /= nf90_noerr) THEN
       WRITE (*,*) 'netcdf error: trj netcdf w', nf90_strerror(status)
       STOP
    ENDIF
  END SUBROUTINE nf
...
CONTAINS
  ...
  SUBROUTINE nf(status) ! turns nf90_* function into subroutine + checks status
    INTEGER :: status
    IF (status /= nf90_noerr) THEN
       WRITE (*,*) 'netcdf error: trj netcdf w 4d', nf90_strerror(status)
       STOP
    ENDIF
  END SUBROUTINE nf
...
CONTAINS
  ...
  SUBROUTINE nf(status) ! turns nf90_* function into subroutine + checks status
    INTEGER :: status
    IF (status /= nf90_noerr) THEN
       WRITE (*,*) 'netcdf error: trj netcdf w 2d', nf90_strerror(status)
       STOP
    ENDIF
  END SUBROUTINE nf
